<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="signUp.aspx.cs" Inherits="csProject.WebForm3" %>
...
<%--                <asp:TextBox ID="usernameCreate" runat="server"></asp:TextBox>--%>
                <input type="text" name="usernameCreate" id="usernameCreate" placeholder="User Name" required>
            </div>
            <div>
...
<%--                <asp:TextBox ID="passwordCreate" runat="server"></asp:TextBox>--%>
                <input type="password" name="passwordCreate" id="passwordCreate" placeholder="Password" required>
            </div>
            <div>
                <div class="password-div">
...
<%--                <asp:TextBox ID="passwordCreate" runat="server"></asp:TextBox>--%>
                <input type="password" name="passwordVerify" id="passwordVerify" placeholder="Verify password" required>
            </div>
...
<%--        </form>--%>            
            <p class="exist" id="match" name="match" runat="server" visible="false">The passwords don't match.</p>
            <p class="errorP" style="display:block" id="nameExists" name="nameExists" runat="server" visible="false">This username already exists</p>
            <p class="errorP" style="display:block" id="passInvalid" name="passInvalid" runat="server" visible="false">Your password should contain both letters and numbers and be at least 4 letters long</p>
            <p class="errorP" style="display:block" id="userInvalid" name="userInvalid" runat="server" visible="false">Your username should contain both letters and numbers and be at least 4 letters long</p>
        </asp:Panel>
    </div>
</asp:Content>
