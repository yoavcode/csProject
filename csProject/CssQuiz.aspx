<%@ Page Title="" Language="C#" MasterPageFile="~/learnCss.master" AutoEventWireup="true" CodeBehind="CssQuiz.aspx.cs" Inherits="csProject.WebForm59" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <!-- javascript -->
    <script defer src="js/quizCss.js"></script>
    <style>
        .font18 {
            font-size: 18px;
        }
