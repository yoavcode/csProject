<%@ Page Title="" Language="C#" MasterPageFile="~/learnJs.master" AutoEventWireup="true" CodeBehind="JsQuiz.aspx.cs" Inherits="csProject.WebForm60" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
        <!-- javascript -->
    <script defer src="js/JsQuiz.js"></script>
    <style>
        .font18 {
            font-size: 18px;
        }
